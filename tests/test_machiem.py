...
class TestMachiEm(unittest.TestCase):
    ...
    def test_combined_response_happiness(self):
        ...
        expected = (
            "Combined response: 20%: Optimally processing: I am so happy! | 20%: Data in flux: I am so happy! | 20%: Encountered an error, adapting: I am so happy! | "
    ...
    def test_combined_response_jealousy(self):
        ...
        expected = (
            "Combined response: 20%: Optimally processing: I am so jealous! | 20%: Data in flux: I am so jealous! | 20%: Encountered an error, adapting: I am so jealous! | "
    ...
    def test_combined_response_surprise(self):
        ...
        expected = (
            "Combined response: 20%: Optimally processing: I am so surprised! | 20%: Data in flux: I am so surprised! | 20%: Encountered an error, adapting: I am so surprised! | "
