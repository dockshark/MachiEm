...
class TestMachiEm(unittest.TestCase):
    ...
    def test_combined_response_disgust(self):
        self.machiem.set_user_preferences("user1", {"weights": {"disgust": 0.3}})
        ...
        expected = (
            ...
            "5%: Responding to jealousy with Envyflare: This is disgusting! | 30%: Responding to disgust with Repulson: This is disgusting! | 10%: Responding to surprise with Astonishlight: This is disgusting! | "
    ...
    def test_combined_response_greed(self):
        self.machiem.set_user_preferences("user1", {"weights": {"greed": 0.1}})
    ...
    def test_combined_response_happiness(self):
        self.machiem.set_user_preferences("user1", {"weights": {"happiness": 0.1}})
        response = self.machiem.process_input("user1", "I am so happy!")
        expected = (
            "Combined response: 10%: Optimally processing: I am so happy! | 10%: Data in flux: I am so happy! | 10%: Encountered an error, adapting: I am so happy! | "
    ...
    def test_combined_response_jealousy(self):
        self.machiem.set_user_preferences("user1", {"weights": {"jealousy": 0.1}})
        ...
        expected = (
            ...
            "10%: Responding to jealousy with Envyflare: I am so jealous! | 5%: Responding to disgust with Repulson: I am so jealous! | 5%: Responding to surprise with Astonishlight: I am so jealous! | "
    ...
    def test_combined_response_surprise(self):
        self.machiem.set_user_preferences("user1", {"weights": {"surprise": 0.1}})
